...
//    public Map<String, Object> metadata;
    ...
    public CustomerEntity(CustomerId id, CustomerAddress customerAddress, String description, String email, String name, String phone, CustomerShipping customershipping, Boolean valid, LocalDateTime createdTime) {
        this.id = id;
