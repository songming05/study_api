...
public class Card {
    ...
    public Card(String cardId, String funding, String brand, String country, String name, Integer exp_month, Integer exp_year, Integer last4, LocalDateTime createdTime) {
        this.cardId = cardId;
